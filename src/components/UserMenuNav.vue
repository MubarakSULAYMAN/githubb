...
export default {
    ...
    menu() {
      return [
        ...
        },
        {
          ...
          link: `/${this.user.login}?tab=repositories`,
        },
        {
          name: 'Projects',
          icon:
          ...
          link: `/${this.user.login}?tab=projects`,
        },
        {
          name: 'Packages',
          icon:
          ...
          link: `/${this.user.login}?tab=packages`,
        },
      ];
    },
  },
  ...
  computed: {
    ...
    ...mapState(['user', 'avatarUrl', 'repoTotalCount', 'showAvatar']),
  },
};
</script>
